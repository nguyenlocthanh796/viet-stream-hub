...
> Cổng phát trực tuyến 1-Click cho cộng đồng người Việt. Phim điện ảnh, truyền hình, anime và thể thao trực tiếp không quảng cáo trên Cloudstream 3, Stremio, Android TV, Mobile và PC.
...
- **Không quảng cáo**: Bỏ qua toàn bộ banner, popup và chuyển hướng từ các web bên thứ ba.
- **Đa nền tảng**: Hỗ trợ Android TV, Google TV, điện thoại Android, iOS, Windows, macOS, Linux.
- **Cài đặt 1-Click**: Thiết lập nguồn phim và kênh trực tiếp thông qua một lệnh hoặc một liên kết.
- **Tự động giám sát**: Tích hợp GitHub Actions định kỳ kiểm tra tình trạng API và độ trễ từng nguồn (KKPhim, NguonC, AnimeVietsub, ThapcamTV).
- **Tuân thủ pháp lý**: Chỉ lập chỉ mục metadata và giao thức mở, không lưu trữ hay truyền tải tệp media có bản quyền trên GitHub.
...
3. Nhập URL:
   ...
   ```
4. Chọn tiện ích cần sử dụng và bấm **Cài đặt**.

### 4. Stremio (Mọi thiết bị)
Bấm liên kết sau nếu thiết bị đã cài Stremio:
...
## Tuyên Bố Pháp Lý (Disclaimer & DMCA)

1. **Bản quyền & Lưu trữ**: `viet-stream-hub` là dự án mã nguồn mở nhằm nghiên cứu công nghệ và lập chỉ mục metadata công khai. Kho lưu trữ hoàn toàn không lưu trữ, tải lên hoặc phát tán bất kỳ tệp video, âm thanh hay hình ảnh có bản quyền nào.
...
3. **Quy trình gỡ bỏ (DMCA Takedown)**: Nếu bạn là chủ sở hữu bản quyền hợp pháp và muốn gỡ bỏ một nguồn chỉ mục cụ thể khỏi repo, vui lòng gửi yêu cầu qua [DMCA Notice Form](.github/ISSUE_TEMPLATE/dmca_takedown.yml). Chúng tôi sẽ tiếp nhận và xử lý trong vòng 24-48 giờ.

---

## Đóng Góp

Mọi ý tưởng đóng góp hoặc đề xuất thêm nguồn API mới:
- Báo lỗi nguồn / Yêu cầu nguồn mới: [Tạo Issue](.github/ISSUE_TEMPLATE/source_request.yml)
- Gửi Pull Request: Chạy script kiểm tra nguồn `./scripts/verify-sources.ps1` trước khi mở PR.
